...
const Location = () => {
  return (
    <div className="w-full h-[680px] md:h-[1000px] lg:h-[700px] flex justify-center items-center overflow-hidden p-8 pt-3 relative">
      <div className="w-[300px] md:w-[560px] lg:w-[1000px] md:h-auto lg:h-auto h-[240px] mt-[220px] md:mt-[410px] lg:mt-0 mx-auto relative unselectable">
        <img
          src={Map}
      ...
      <div className="absolute lg:w-[1300px] lg:h-[700px] mt-5 lg:mt-14 flex justify-end items-start md:mt-0 lg:top-8 lg:right-8">
