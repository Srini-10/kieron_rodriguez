  ...
  return (
    <>
      <div
        ...
        className="max-w-[1440px] mx-auto h-[681px] overflow-hidden flex justify-between relative items-center"
      >
        ...
        <div className="w-full h-full absolute bg-white bg-opacity-10">
          <img
            src={P1}
            className="w-[50px] absolute top-10 left-96 transition-transform duration-1000 ease-out"
          ...
          <img
            src={P3}
            className="w-[20px] rotate-12 absolute bottom-16 left-64 transition-transform duration-1000 ease-out"
        ...
        {/* Content */}
        <div className="max-w-[560px] overflow-hidden h-full relative flex justify-center items-center z-10">
          <img
            className="min-w-[600px] saturate-[1.3] mt-0 ml-28"
            src={Baby}
            alt="Baby"
          />
          ...
          {/* Background image */}
          <img
            className="absolute top-32 left-10 w-[160px] object-cover rotate-[-83deg] z-10" // Absolute positioning for background image
            src={Cap}
            alt=""
          />
          <img
            className="absolute top-[236px] left-[450px] w-[110px] saturate-150 object-cover rotate-[-6deg] z-10" // Absolute positioning for background image
            src={Cap2}
            alt=""
          />
        </div>
        ...
        <div className="w-full h-full flex justify-center items-center">
          <div className="relative w-full h-[340px]">
            <h1 className="relative text-[40px] text-center inter-extrabold z-10">
              We invite you to{" "}
              <span className="bg-violet-600 text-white px-2">celebrate</span>
            </h1>
            <p className="text-[40px] text-center inter-extrabold mt-1 flex justify-center items-center z-10">
              <span className="text-violet-600 underline">
                Kieron Rodriguez's
              </span>{" "}
              <span className="flex mx-3">
                f
                <span className="w-3 h-[45px] overflow-hidden">
                  <img
                    src={Candle}
                    className="h-full scale-[1.5] w-auto mt-[5px] object-cover"
                    alt=""
                  />
                </span>
                rst
              ...
              <span className="bg-rose-100 px-2 -mx-2 relative inline-block">
                ...
                <img
                  src={Baloon}
                  alt="Birthday Cap"
                  className="absolute top-[-103px] rotate-6 right-[-83px] w-32 -z-10"
                />
              </span>
            </p>

            <div className="w-[500px] gap-x-8 mx-auto mt-20 z-50 flex justify-between items-center">
