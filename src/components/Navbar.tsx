...
import Name from "../assets/name8.svg";
...
const Navbar = () => {
  return (
    <>
      <div className="w-[1300px] h-[80px] mt-6 border-b-[1px] bg-white border-slate-200 flex items-center z-50 justify-between mx-auto">
        <ul className="flex gap-x-12 items-center lexend-light w-[350px]">
          <li className="">Story</li>
          <li className="">Family</li>
          <li className="">Gallery</li>
          <li className="">Contact</li>
        </ul>
        <div className="h-[80px] w-[360px] overflow-hidden flex justify-center items-center">
          <img
